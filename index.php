...
@media (max-width: 350px){
    ...
    <nav>
        ...
        <ul id="ul1">
            ...
            <li><a href="./shop/shop.php" id="l2" class="lii">S<span>h</span><span>o</span><span>p</span></a></li>
            <li><a href="./about/about.php" id="l3" class="lii">A<span>b</span><span>o</span><span>u</span><span>t</span></a></li>
            <li><a href="./contact/contact.php" id="l4">C<span>o</span><span>n</span><span>t</span><span>a</span><span>c</span><span>t</span></a></li>
        </ul>
    ...
    <div class="products">
        ...
        <a href="./shop/produkti.php?id=29">
        ...
        <a href="./shop/produkti.php?id=17">
        <div class="product" id="product-6">
            <div class="imgdiv">
                <img src="./img/product42.png" alt="Produkti 1" class="product-image">
            </div>
    ...
    <div class="second">
        ...
        <div class="right">
            ...
            <div class="bottom">
                ...
                <a href="./shop/produkti.php?id=37">
                    <div class="imgdiv">
